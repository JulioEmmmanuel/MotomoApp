...
import com.example.motomoapp.databinding.FragmentGiftcardBinding
...
class GiftCardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val homeViewModel =
            ViewModelProvider(this).get(GiftcardViewModel::class.java)

        _binding = FragmentGiftcardBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textGiftcard
